...
(function () {
  ...
  var Doc = 'Document',
      doc = document,
      DOCUMENT = this[Doc] || this.HTMLDocument,
      // IE8
  WIN = 'Window',
      win = window,
      WINDOW = this.constructor || this[WIN] || Window,
      // old Safari
  ...
  EVENT = 'Event',
      ...
      dispatchEvent = 'dispatchEvent'; // Element
  ...
  if (!(classList in ELEMENT[prototype])) {
    var ClassLIST = function ClassLIST(elem) {
      var classArr = (elem[getATTRIBUTE](CLASS) || '').replace(/^\s+|\s+$/g, '')[split](/\s+/) || []; // methods
